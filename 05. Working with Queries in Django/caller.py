...
def find_authors_nationalities():
    ...
    for auther in authors:
        result.append(f"{auther.first_name} {auther.last_name} is {auther.nationality}")
    return "\n".join(result)
...
def filter_authors_by_nationalities(nationality):
    ...
    for author in authors:
        result.append(author.biography) if author.biography is not None else result.append(f"{author.first_name} {author.last_name}")
